...
class QuestionViewSet(viewsets.ModelViewSet):
    ...
    """
    queryset = Question.objects.select_related('author').prefetch_related('choice_set').all()
    ...
    def vote(self, request, pk=None, **kwargs):
        ...
        try:
            ...
            return Response(
                {"error_code": "INVALID_CHOICE", "message": "This choice does not exist for this question."},
